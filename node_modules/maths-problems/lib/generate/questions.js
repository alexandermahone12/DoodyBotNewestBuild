...
function generateQuestion(problem, number) {
  ...
  var variables = (0, _variables.generateVariables)(problem.question);
  if (variables.length == 0) {
    // No variables, simple question and answer
    return new _models.Question(problem.question, variables);
  } else {
    return new _models.Question((0, _variables.insertVariables)(problem.question, variables), variables, number);
  }
}